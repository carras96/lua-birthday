...
const StakeModal = ({ toggleModal }) => {
    ...
    return <Wrapper>
        ...
        <ModalDesc>Stake at least 500 LUA in LuaSafe to be eligible</ModalDesc>
        ...
        <GuideDetail>
            ...
            <TextGuide>3. Click <b>Stake</b> button and enter the number of LUA you want to stake (at least 500 LUA)</TextGuide>
